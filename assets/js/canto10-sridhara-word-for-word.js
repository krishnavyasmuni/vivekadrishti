(() => {
  ...
  const OVERRIDE_BASE = '/vivekadrishti/assets/data/canto10-sridhara-word-for-word/';
  ...
  const COMMON = new Map(Object.entries({
    'a':'not','an':'not','na':'not','no':'not','mā':'do not','ca':'and','tu':'but','api':'also','eva':'only; indeed','hi':'indeed; because','vai':'indeed','uta':'and; also','atha':'now; then','athavā':'or else','vā':'or','api vā':'or also','khalu':'indeed','nūnam':'certainly','kila':'indeed; it is said','sma':'indeed; formerly','ha':'indeed','aho':'oh','hanta':'alas; indeed','bata':'alas; indeed',
    'iti':'thus','ity':'thus','ityādi':'and so on','ity-ādi':'and so on','ityarthaḥ':'this is the meaning','ity-arthaḥ':'this is the meaning','iti arthaḥ':'this is the meaning','itibhāvaḥ':'thus is the sense','iti-bhāvaḥ':'thus is the sense','iti bhāvaḥ':'thus is the sense','ityāha':'thus he says','ity-āha':'thus he says','iti āha':'thus he says','ityuktam':'thus stated','ity-uktam':'thus stated',
    ...
    'yataḥ':'because; from which','ataḥ':'therefore; from this','tataḥ':'then; from that','yasmāt':'because; from which','tasmāt':'therefore; from that','yathā':'as; just as','tathā':'so; in that way','yathāvat':'properly; as it is','yathoktam':'as stated','yathā-uktam':'as stated','yathāyogam':'as appropriate','yathā-yogam':'as appropriate','yathāsaṅkhyam':'in corresponding order','yathā-saṅkhyam':'in corresponding order','yadā':'when','tadā':'then','yadi':'if','cet':'if','tarhi':'then','kintu':'but','kiṁtu':'but','tathāpi':'nevertheless','ataeva':'therefore indeed','ata eva':'therefore indeed',
    'kim':'what','kiṁ':'what','kaḥ':'who','kā':'who; which','ke':'who; which','kasya':'whose; of whom','kasmai':'to whom','kasmāt':'from whom; why','katham':'how','kutaḥ':'from where; why','kati':'how many','kimartham':'for what purpose; why','kim-artham':'for what purpose; why','nanu':'but surely; indeed','nanv':'but surely','uta aho':'or indeed',
    ...
    'asti':'is','santi':'are','āsīt':'was','bhavati':'is; becomes','bhavanti':'are; become','bhavet':'may be; becomes','syāt':'may be','sambhavati':'arises; is possible','ghaṭate':'is possible; occurs','vartate':'exists; remains','tiṣṭhati':'stands; remains','avasthita':'situated','vidyate':'exists','nāsti':'does not exist','na asti':'does not exist','abhāva':'absence','sattā':'existence',
    'karoti':'does; makes','kurute':'does; makes','kuru':'do; make','kṛtvā':'having done; having made','kṛta':'done; made','kṛtam':'done; made','kṛtaḥ':'done; made','akārṣīt':'did','dadāti':'gives','dattam':'given','datta':'given','dattvā':'having given','prayacchati':'bestows','prayacchataḥ':'of one who bestows','gṛhṇāti':'takes','gṛhītvā':'having taken','dhārayati':'holds','dhṛta':'held; bearing','tyajati':'abandons','tyaktvā':'having abandoned','rakṣati':'protects','arakṣat':'protected','rakṣita':'protected','jagopa':'protected','hanti':'kills','hatvā':'having killed','hata':'killed','vadha':'killing','jayati':'conquers','jita':'conquered','tarati':'crosses','atran':'they crossed','ataran':'they crossed','gacchati':'goes','agāt':'went','gata':'gone','gataḥ':'gone','gatvā':'having gone','āgata':'come; arrived','āgatya':'having come','praviśati':'enters','praviṣṭa':'entered','nirgacchati':'goes out','upaiti':'approaches; attains','eti':'goes; comes','yāti':'goes','nayati':'leads','ānayati':'brings','labhate':'obtains','labdha':'obtained','prāpnoti':'attains','prāpta':'attained','utpadyate':'arises; is born','jāyate':'is born','jāta':'born','janma':'birth','mriyate':'dies','mṛtyu':'death','jīvati':'lives','jīva':'living being',
    ...
    'satya':'true; truth','satyam':'true','mithyā':'false','śubha':'auspicious','aśubha':'inauspicious','sukha':'happiness','duḥkha':'suffering','ānanda':'bliss','paramānanda':'supreme bliss','prema':'love','kāma':'desire','krodha':'anger','lobha':'greed','moha':'delusion','bhaya':'fear','śoka':'sorrow','tṛṣṇā':'thirst; craving','tarṣa':'thirst; craving','icchā':'desire','dayā':'compassion','kṛpā':'mercy','prasāda':'grace; favor','mahima':'greatness','yaśas':'glory','tejas':'splendor; power','bala':'strength','śaurya':'heroism','aiśvarya':'lordship; opulence','mādhurya':'sweetness','saundarya':'beauty','doṣa':'fault','guṇaḥ':'quality','kāraṇa':'cause','hetu':'cause; reason','phala':'fruit; result','upāya':'means','sādhana':'means; practice','sādhya':'goal','viṣaya':'object; subject','āśraya':'shelter','ādhāra':'support','nimitta':'cause; occasion','prayojana':'purpose','sambandha':'relation','bīja':'seed','nidāna':'source; cause','anta':'end','ādi':'beginning; and so on','madhya':'middle','krama':'order; sequence','prakāra':'manner; kind','rīti':'manner','rasa':'rasa; relish','amṛta':'nectar; immortality','mṛta':'dead','amṛtam':'nectar; immortality',
    'sahita':'together with','saha':'with','vinā':'without','ṛte':'without; except','prati':'toward; regarding','anu':'after; according to','upari':'upon','adhika':'more; greater','nyūna':'less; deficient','tulya':'equal; like','iva':'like; as if','vat':'like; possessing','mātra':'only; measure','kevala':'only; exclusive','evaṁ':'thus; in this way','evam':'thus; in this way','tadvat':'like that','tad-vat':'like that','sarvathā':'in every way','viśeṣataḥ':'especially','prāyaḥ':'generally; mostly','vastutaḥ':'in reality','sākṣāt':'directly','svataḥ':'by itself; intrinsically','parasparam':'mutually','krameṇa':'gradually; in order','saṅkṣepeṇa':'briefly','vistareṇa':'in detail','spaṣṭam':'clearly','sphuṭam':'clearly','samyak':'properly; completely','ati':'very; exceedingly','atyanta':'extreme; complete','nitarām':'greatly','sarvadā':'always',
    ...
    'samudra':'ocean','sāgara':'ocean','nadī':'river','jala':'water','vāri':'water','agni':'fire','vahni':'fire','sūrya':'sun','soma':'moon','candra':'moon','pṛthivī':'earth','bhūmi':'earth','ākāśa':'ether; sky','vāyu':'air','vana':'forest','giri':'mountain','parvata':'mountain','nagara':'city','pura':'city','gṛha':'house','grāma':'village','ratha':'chariot','cakra':'disc; wheel','gadā':'mace','astra':'weapon','śastra':'weapon','yuddha':'battle','samara':'battle','sainya':'army','śatru':'enemy','mitra':'friend','plava':'boat','timiṅgila':'timiṅgila sea-monster','vatsa':'calf','padaṁ':'footprint; step',
    'ādau':'at the beginning','ante':'at the end','mūlam':'root; basis','mūla':'root; basis','siddha':'established; perfected','siddham':'established','prasiddha':'well known','aprasiddha':'not well known','sambandhaḥ':'relation','saṅgati':'connection','saṅgatiḥ':'connection','udāharaṇa':'example','dṛṣṭānta':'example','nirṇaya':'conclusion','siddhānta':'conclusion; doctrine','saṁśaya':'doubt','samādhāna':'resolution; answer','praśna':'question','uttaraḥ':'answer','pūrvapakṣa':'prima facie objection','siddhāntaḥ':'established conclusion','tātparyam':'purport','vyavahāra':'usage; practice','laukika':'ordinary; worldly','vaidika':'Vedic','śāstrīya':'scriptural'
  }));
  ...
  const CASE_RULES = [
    ...
    [/inaḥ$/u, 'in', 'of {x}'], [/inā$/u, 'in', 'by {x}'], [/ini$/u, 'in', 'in {x}'], [/inaṁ$/u, 'in', '{x}'],
  ...
  function cleanMeaning(text) {
    return String(text || '')
      ...
      .replace(/^[-—–,:;\s]+|[-—–,:;\s]+$/g, '')
      .replace(/\s*\([^)]{0,100}\)\s*/g, ' ')
      .replace(/\b(?:m|f|n|mf|mfn|adj|adv|ind|pron|part|prep|conj|interj)\.?\s*/gi, '')
      .replace(/\s+/g, ' ')
      .trim();
  }
  ...
  function contextLexicon(section) {
    const map = new Map();
    const detail = section.querySelector(':scope > .sb-word-details');
    const text = detail?.querySelector('.sb-source-content')?.textContent || '';
    text.split(/\s*;\s*/).forEach((piece) => {
      const parts = piece.split(/\s+[—–-]\s+/);
      if (parts.length < 2) return;
      const left = normalize(parts.shift());
      const right = cleanMeaning(parts.join(' — '));
      if (left && right) map.set(left, right.replace(/[.;]+$/g, ''));
    });
    return map;
  }
  ...
  function sridharaExists(section) {
  ...
  async function chapterOverrides(chapter) {
    if (chapter !== 1) return {};
    if (!overrideCache.has(chapter)) {
      overrideCache.set(chapter, fetch(`${OVERRIDE_BASE}01.json`, { cache: 'no-cache' })
  ...
  function overrideForRange(glosses, start, end) {
    const key = start === end ? String(start) : `${start}-${end}`;
    if (glosses[key]) return glosses[key];
    if (start === end) return '';
    return Array.from({ length: end - start + 1 }, (_, index) => glosses[String(start + index)] || '').filter(Boolean).join(' ').trim();
  }
  ...
  function localLookup(token, context) {
    ...
    const withoutAvagraha = key.replace(/^'|'‌?/g, '');
  ...
  function dictionaryCandidates(token) {
    ...
    if (!key) return [];
    const out = [key];
    CASE_RULES.forEach(([pattern, replacement]) => {
      if (pattern.test(key)) out.push(key.replace(pattern, replacement));
    });
    if (key.endsWith('ḥ')) out.push(key.slice(0, -1));
    if (key.endsWith('m')) out.push(key.slice(0, -1));
    if (key.endsWith('ṃ')) out.push(key.slice(0, -1));
    if (key.endsWith('am')) out.push(key.slice(0, -2) + 'a');
    if (key.endsWith('ena')) out.push(key.slice(0, -3) + 'a');
    if (key.endsWith('asya')) out.push(key.slice(0, -4) + 'a');
    return [...new Set(out.filter((value) => value.length > 1))].slice(0, 6);
  }
  ...
  function extractDictionaryMeaning(payload) {
    ...
    for (const dict of order) {
      ...
      if (Array.isArray(entry.sense) && entry.sense.length) {
        const sense = cleanMeaning(typeof entry.sense[0] === 'string' ? entry.sense[0] : entry.sense[0]?.text || '');
      ...
      let text = cleanMeaning(raw)
        .replace(/^[\u0900-\u097f\s0-9.,;:'"()\-]+/u, '')
        .replace(/^[a-zāīūṛṝḷṃṁḥṅñṭḍṇśṣ0-9.'\-]+\s+/iu, '');
  ...
  function makeGlossLine(units, meanings) {
    return units.map((unit, index) => `${unit} — ${meanings[index] || '…'}`).join('; ') + (units.length ? '.' : '');
  }

  async function resolveGloss(iast, context, content, forceRemote) {
    const tokens = tokensFromIast(iast);
    const units = [];
    tokens.forEach((token) => {
      const whole = localLookup(token, context) || cachedDictionaryLookup(token);
      if (whole) units.push(token);
      else units.push(...tokenUnits(token));
    });

    const meanings = units.map((unit) => localLookup(unit, context) || cachedDictionaryLookup(unit));
    content.textContent = makeGlossLine(units, meanings);
    if (!forceRemote) return;

    const unresolved = [];
    meanings.forEach((meaning, index) => { if (!meaning && !unresolved.includes(units[index])) unresolved.push(units[index]); });
    ...
    const workers = Array.from({ length: Math.min(4, queue.length) }, async () => {
      while (queue.length) {
        ...
        for (let i = 0; i < units.length; i += 1) {
          if (units[i] === unit) meanings[i] = localLookup(unit, context) || cachedDictionaryLookup(unit);
        }
        content.textContent = makeGlossLine(units, meanings.map((meaning, i) => meaning || units[i]));
      }
    });
  ...
  async function enhance(section) {
    ...
    if (!sridharaExists(section)) return;
    ...
    const overrides = await chapterOverrides(identity.chapter);
    const override = overrideForRange(overrides, identity.start, identity.end);
    if (override) {
      content.textContent = override;
      details.dataset.complete = 'verified-override';
      return;
    }

    const context = contextLexicon(section);
    await resolveGloss(iast, context, content, false);
    details.addEventListener('toggle', () => {
      if (details.open && details.dataset.remoteResolved !== 'true') {
        details.dataset.remoteResolved = 'true';
        resolveGloss(iast, context, content, true);
      }
    });
  }
